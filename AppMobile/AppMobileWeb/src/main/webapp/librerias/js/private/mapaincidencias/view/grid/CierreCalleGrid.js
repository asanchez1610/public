...
//						});
						...
						if(IS_CONSULTA){
								...
								columnas.push({
							            ...
							            items: [{
							                ...
							                icon: '/mobileApps/images/map_icon.png',
							                tooltip: 'Ver Mapa',
							                handler: function(grid, rowIndex, colIndex) {
							                    ...
							                    Ext.create('Ext.window.Window', {
												    ...
												    items: {  
												        xtype: 'panel',
												        border: false,
												        html:'<iframe style="width:100%;height:100%;" scrolling="no" frameborder="0" src="/mobileApps/cierre-calles/view-mapa-consulta?idIncidencia='+rec.data.idIncidencia+'&puntos='+strPuntos.join('_______')+'"></iframe>'
					...
					initComponent : function() {
						...
						store.proxy.url = this.url
								|| '/mobileApps/mapa-incidencia/incidencias-list';
						this.store = store;
...
//										hidden:true,
									...
									,
									{
										...
										text:'Nuevo',
										hidden:hideButons,
										href:'/mobileApps/cierre-calles/registro?token=6df112b7e941caffe79bd04f788d05e6',
										hrefTarget:'_self',
										handler : function() {
											CierreCalle.service.loadGrid();
										}
