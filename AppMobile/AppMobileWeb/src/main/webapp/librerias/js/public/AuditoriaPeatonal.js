...
//	$.getJSON("/mobileApps/auditoria-peatonal/get-catalogo?idGrupo=319",
//			function(resp) {
...
//			});
	...
	$.get( "/mobileApps/auditoria-peatonal/get-catalogo?idGrupo=319", function( resp ) {
...
//	});
	...
	$("#cbxCalles").autocomplete(
			{
				...
				source : [ function(q, add) {
					...
					$.getJSON(
							"/mobileApps/auditoria-peatonal/listar-calles-miraflores?query="
	...
	$('#btn-enviar').click(function(){
		...
		$.ajax({
			url : "/mobileApps/auditoria-peatonal/registrar-formulario",
